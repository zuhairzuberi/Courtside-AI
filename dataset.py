...
class BasketballDataset(Dataset):
    ...
    def __init__(self, annotation_dict, augmented_dict, video_dir="/content/drive/MyDrive/archive_temp/examples/", augmented_dir="/content/basketball-action-recognition/Dataset/augmented-videos/", augment=True, transform=None, poseData=False):
    ...
    def VideoToNumpy(self, video_id):
        ...
        if not video.isOpened():
            raise Exception("Video file not readable" + self.augmented_dir + video_id + ".mp4")
